...
Artifacts: `reports/selection/l1/` (re-run with `CONFIG=configs/default_mi_subset.yaml`)

## Training Outcomes

| Config | Encoded Features | ROC AUC (test) | Avg Precision | Threshold | W&B Run |
| --- | --- | --- | --- | --- | --- |
| `configs/default_mi_subset.yaml` | 92 | 0.657 | 0.340 | 0.431 | [4vbv75sy](https://wandb.ai/petr-encode-peterlamb/loan-risk-mlp/runs/4vbv75sy) |
| `configs/default_l1_subset.yaml` | 89 | **0.723** | **0.407** | 0.483 | [4wd8uyoe](https://wandb.ai/petr-encode-peterlamb/loan-risk-mlp/runs/4wd8uyoe) |
| `configs/default_l1_on_mi_subset.yaml` | 89 | 0.676 | 0.348 | 0.434 | [ewhrixls](https://wandb.ai/petr-encode-peterlamb/loan-risk-mlp/runs/ewhrixls) |
...
```
make select CONFIG=configs/default_no_winsor.yaml METHOD=mi
make select CONFIG=configs/default_no_winsor.yaml METHOD=l1
make select CONFIG=configs/default_mi_subset.yaml METHOD=l1  # chained run
make train CONFIG=configs/default_mi_subset.yaml
make train CONFIG=configs/default_l1_subset.yaml
make train CONFIG=configs/default_l1_on_mi_subset.yaml
```
