...
# Run the FULL dataset H2O sweep (agnostic, selected, aware, selected_plus_providers)
...
declare -a CONFIGS=(
  "docs/experiments/suites/thesis_iter1/h2o/full/agnostic_time.yaml"
  "docs/experiments/suites/thesis_iter1/h2o/full/selected_time.yaml"
  "docs/experiments/suites/thesis_iter1/h2o/full/aware_time.yaml"
  "docs/experiments/suites/thesis_iter1/h2o/full/selected_plus_providers_time.yaml"
)

# If resuming, skip configs already marked OK in the existing log.
LOG_PATH="logs/run_full_sweep.log"
