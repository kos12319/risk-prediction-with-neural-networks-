...
declare -a CONFIGS=(
  "docs/experiments/suites/thesis_iter1/h2o/100k/agnostic_time.yaml"
  "docs/experiments/suites/thesis_iter1/h2o/100k/selected_time.yaml"
  "docs/experiments/suites/thesis_iter1/h2o/100k/aware_time.yaml"
  "docs/experiments/suites/thesis_iter1/h2o/100k/selected_plus_providers_time.yaml"
)

# If resuming, skip configs already marked OK in the existing log.
LOG_PATH="logs/run_100k_sweep.log"
